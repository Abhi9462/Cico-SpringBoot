...
public class StudentRestController {
	...
	public ResponseEntity<ApiResponseDto> login(@RequestBody JwtRequestDto dto){
		...
		Student currentStudent = studentService.getCurrentStudent(dto.getUserId());
		
		ApiResponseDto responseDto=new ApiResponseDto(200, "Success", token,currentStudent);
...
//	
	...
	public ResponseEntity<ApiResponseDto> checkIn(@RequestBody Attendance attendance){
		...
		ApiResponseDto responseDto=new ApiResponseDto(200, "Success", attendance2,null);
        return ResponseEntity.ok(responseDto);
	}
